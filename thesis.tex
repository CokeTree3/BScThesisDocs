...
%% First supervisor.
\thsvfirst{Erik van der Kouwe}{Assistant Professor}

%% Daily supervisors.
\thsvdaily{Mohammad Sina Karvandi, Björn Ruytenberg}{PhD Student, PhD Student}

%% Second reader.
\thrdrsecond{Mohammad Sina Karvandi}{PhD Student}
